...
class ListCategoiresSpirtual extends GetView<SpirtualControllerImp> {
  const ListCategoiresSpirtual({super.key});
...
class Categories extends GetView<SpirtualControllerImp> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        //  controller.GotoSpirtuals(controller.categories, i!);
          ...
          GetBuilder<SpirtualControllerImp>(
            builder: (controller) => Container(
              ...
              child: Text(
                ...
                style:
                    const TextStyle(fontSize: 20, color: AppColor.thirdcolor),
              ),
            ),
          )
        ],
