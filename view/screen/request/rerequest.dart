import 'package:alaraaf/controller/request/rerequestcontroller.dart';
...
class Rerequest extends StatefulWidget {
  const Rerequest({super.key});

  @override
  State<Rerequest> createState() => _RerequestState();
}

class _RerequestState extends State<Rerequest> {
  GlobalKey<FormState> formstate = GlobalKey<FormState>();
  // late File file;
  @override
  Widget build(BuildContext context) {
    Get.put(RerequestControllerImp());
    RerequestControllerImp controllerIm = Get.put(RerequestControllerImp());
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
      ...
      body: GetBuilder<RerequestControllerImp>(
                ...
                children: [
                  ...
                  CustomButtonAuth(
                    ...
                    onPressed: () {
                      ...
                      setState(() {});
                      controller.request(
                          controller.requestModel.spiritual_id,
                          controller.requestModel.request_price,
                          controller.requestModel.request_id);
                    },
                  ),
