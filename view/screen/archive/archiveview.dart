import 'package:alaraaf/controller/archive/archivecontroller.dart';
...
class ArchiveView extends StatefulWidget {
  ...
  @override
  State<ArchiveView> createState() => ArchiveViewState();
}

class ArchiveViewState extends State<ArchiveView> {
  @override
  Widget build(BuildContext context) {
    Get.put(ArchiveViewControllerImp());
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
      ...
      body: Padding(
        ...
        child: Container(
          ...
          child: GetBuilder<ArchiveViewControllerImp>(
