...
abstract class ResponseViewController extends GetxController {
  initialData();
  goToPageResponseDetails(ResponseModel responseModel);
}

class ResponseViewControllerImp extends ResponseViewController {
  String? userid;
  ResponseData requestData = ResponseData(Get.find());
