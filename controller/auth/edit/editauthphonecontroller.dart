...
abstract class EditAuthPhoneController extends GetxController {
  goToEditPhone();
}

class EditAuthPhoneControllerImp extends EditAuthPhoneController {
  ...
  EditPhone() async {
    ...
    if (formdata!.validate()) {
      ...
      update();
      var response = await editData.editUserPhone(
          myServices.sharedPreferences.getInt("userid").toString(), phone.text);
